...
class FrontEnd{
    ...
    public function maybe_add_share_buttons( $content ) {
      ...
      if( ! is_singular() || ! in_array( 'the_content', $wp_current_filter ) || !$this->options ) {
        return $content;
      }
    ...
    private function add_buttons( $id, $url, $title, $content, $top, $bottom ){
      ...
      $new_content_top = "";
      if( $top ){
        $new_content_top .= "<div class='share-buttons-block'>";
          ...
          $new_content_top .= "<a class='share-button btn btn-default whatsapp' href='whatsapp://send?text=" . $title . "' data-action='share/whatsapp/share' title='". __( 'Share This on Whatsapp', SHARE_BUTTONS_SLUG ). "'><i class='kaf-icon kaf-icon-whatsapp'></i>Whatsapp</a>";
        $new_content_top .= "</div>";
      }
      if( $bottom ){
        $new_content_bottom .= "<div class='share-buttons-block'>";
          ...
          $new_content_bottom .= "<a class='share-button btn btn-default whatsapp' href='whatsapp://send?text=" . $title . "' data-action='share/whatsapp/share' title='". __( 'Share This on Whatsapp', SHARE_BUTTONS_SLUG ). "'><i class='kaf-icon kaf-icon-whatsapp'></i>Whatsapp</a>";
